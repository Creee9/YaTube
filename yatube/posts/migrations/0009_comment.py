# Generated by Django 2.2.16 on 2023-03-24 09:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(help_text='Выберите пост, который комментировать', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='posts.Post', verbose_name='Пост')),
            ],
        ),
    ]
